...
public class btown extends AppCompatActivity {
    ...
    private FirebaseRecyclerAdapter<News, btown.NewsViewHolder> mPeopleRVAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPeopleRVAdapter = new FirebaseRecyclerAdapter<News, btown.NewsViewHolder>(personsOptions) {
            @Override
