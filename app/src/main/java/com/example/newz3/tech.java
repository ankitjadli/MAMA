...
public class tech extends AppCompatActivity {
    ...
    private FirebaseRecyclerAdapter<News, tech.NewsViewHolder> mPeopleRVAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPeopleRVAdapter = new FirebaseRecyclerAdapter<News, tech.NewsViewHolder>(personsOptions) {
            @Override
