...
public class world extends AppCompatActivity {
    ...
    private FirebaseRecyclerAdapter<News, world.NewsViewHolder> mPeopleRVAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPeopleRVAdapter = new FirebaseRecyclerAdapter<News, world.NewsViewHolder>(personsOptions) {
            @Override
